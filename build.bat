...
set CommonDefines=/Iext\SDL2-2.0.12\include /Iext\mimalloc-1.6.4\include /D_CRT_SECURE_NO_WARNINGS /DWIN32_LEAN_AND_MEAN /DPLATFORM_WINDOWS /DUNICODE /D_UNICODE
