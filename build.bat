...
set PlatformLinkerFlags=/INCREMENTAL:NO /OPT:REF /MACHINE:X64 /NOIMPLIB %SDLDependencies% user32.lib gdi32.lib opengl32.lib winmm.lib /OUT:%BinOutDir%\win32_gl3_gates.exe /PDB:%BinOutDir%\win32_gl3_gates.pdb
